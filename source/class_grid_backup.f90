        ...
        select case(dust_geometry%type)
            ...
            case("shell")
               ...
               if (lg_decoupled) then
                ...
                !calculate density of a clump bdensityased on mass of clump and volume of clump
                ...
                print*,"clumpdensity",dust_geometry%rho_clump
                ...
                print*,"true avg dust no. density",mothergrid%n_rho_dust_av                
